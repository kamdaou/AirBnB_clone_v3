...
**hbnb** is a full-stack clone of the web application [AirBnB](https://www.airbnb.com/). This clone was built in four iterative phases. This version includes completion of Phase 1 from [AirBnB_clone_v1: Console and web static](https://github.com/kamdaou/AirBnB_clone_v1), Phase 2 from [AirBnB_clone_v2](https://github.com/kamdaou/AirBnB_clone_v2) plus Phase 3, which involves exposing stored objects via a JSON web interface and manipulating objects via a custom RESTful API.
...
* [AirBnB_clone_v1: Console and web static](https://github.com/kamdaou/AirBnB_clone_v1)
* [AirBnB_clone_v2: MySQL, deploy web static, web framework](https://github.com/kamdaou/AirBnB_clone_v2)
<!-- * [AirBnB_clone_v4: Web dynamic](https://github.com/kamdaou/AirBnB_clone_v4) (Final version!) -->
...
## File Descriptions
  **Note:** Below highlights only new file additions for Phase 3. For file descriptions from previous phases, click [Phase 2](https://github.com/kamdaou/AirBnB_clone_v2) and [Phase 1](https://github.com/kamdaou/AirBnB_clone_v1).
...
## Authors
Phase 3:
* Ngomdé Cadet KAMDAOU | [GitHub](https://github.com/kamdaou) | [LinkedIn](https://linkedin.com/in/kamdaou-android-developer)

**Note: As per ALX's requirements, we practice working with new Phase 1 and 2 codebases in our Phase 3 version.**
